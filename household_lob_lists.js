var groupedOptions = {
  ...
  int_party_type_options: [
    { value: 'co-owner', text: 'Co-Owner' },
    { value: 'credit_sale', text: 'Credit Sale' },
    { value: 'debenture_holder', text: 'Debenture Holder' },
    { value: 'first_mortgagee', text: 'First Mortgagee' },
    { value: 'freeholder', text: 'Freeholder' },
    { value: 'ground_landlord', text: 'Ground Landlord' },
    { value: 'heritable_creditor_-_primo_loco', text: 'Heritable Creditor - Primo Loco' },
    { value: 'heritable_creditor_-_secundo_loco', text: 'Heritable Creditor - Secundo Loco' },
    { value: 'heritable_creditor_-_tertio_loco', text: 'Heritable Creditor - Tertio Loco' },
    { value: 'hire_purchase', text: 'Hire Purchase' },
    { value: 'hirer', text: 'Hirer' },
    { value: 'holder_of_a_floating_charge', text: 'Holder Of A Floating Charge' },
    { value: 'landlord', text: 'Landlord' },
    { value: 'leaseholder', text: 'Leaseholder' },
    { value: 'lessee', text: 'Lessee' },
    { value: 'lessor', text: 'Lessor' },
    { value: 'mortgagee', text: 'Mortgagee' },
    { value: 'mortgagee_of_the_leaseholder_interest', text: 'Mortgagee Of The Leaseholder Interest' },
    { value: 'mortgagor', text: 'Mortgagor' },
    { value: 'operator', text: 'Operator' },
    { value: 'other_lender', text: 'Other Lender' },
    { value: 'other_occupier', text: 'Other Occupier' },
    { value: 'owner', text: 'Owner' },
    { value: 'proprietor_in_reversion', text: 'Proprietor In Reversion' },
    { value: 'registered_keeper', text: 'Registered Keeper' },
    { value: 'second_mortgagee', text: 'Second Mortgagee' },
    { value: 'standard_bank_interest', text: 'Standard Bank Interest' },
    { value: 'tenant', text: 'Tenant' },
    { value: 'zz_-_not_covered_by_any_other_item_on_the_list', text: 'ZZ - Not Covered By Any Other Item On The List' }
  ],
  int_party_country_options: [
    { value: 'albania', text: 'Albania' },
    { value: 'algeria', text: 'Algeria' },
    { value: 'american_samoa', text: 'American Samoa' },
    ...
    { value: 'bouvet_island', text: 'Bouvet Island' },
    { value: 'brazil', text: 'Brazil' },
    { value: 'british_indian_ocean_territory', text: 'British Indian Ocean Territory' },
    { value: 'brunei_darussalam', text: 'Brunei Darussalam' },
    ...
    { value: 'cayman_islands', text: 'Cayman Islands' },
    { value: 'central_african_republic', text: 'Central African Republic' },
    { value: 'chad', text: 'Chad' },
    { value: 'chile', text: 'Chile' },
    { value: 'china', text: 'China' },
    { value: 'christmas_island', text: 'Christmas Island' },
    { value: 'cocos_(keeling)_islands', text: 'Cocos (Keeling) Islands' },
    ...
    { value: 'european_community', text: 'European Community' },
    { value: 'european_union', text: 'European Union' },
    { value: 'falkland_islands_(malvinas)', text: 'Falkland Islands (Malvinas)' },
    { value: 'faroe_islands', text: 'Faroe Islands' },
    { value: 'fiji', text: 'Fiji' },
    { value: 'finland', text: 'Finland' },
    { value: 'france', text: 'France' },
    { value: 'france,_metropolitan', text: 'France, Metropolitan' },
    { value: 'french_guiana', text: 'French Guiana' },
    { value: 'french_polynesia', text: 'French Polynesia' },
    { value: 'french_southern_territories', text: 'French Southern Territories' },
    { value: 'gabon', text: 'Gabon' },
    { value: 'gambia', text: 'Gambia' },
    { value: 'georgia', text: 'Georgia' },
    { value: 'german_democratic_republic', text: 'German Democratic Republic' },
    ...
    { value: 'heard_island_and_mcdonald_islands', text: 'Heard Island And Mcdonald Islands' },
    { value: 'holy_see_(vatican_city_state)', text: 'Holy See (Vatican City State)' },
    ...
    { value: 'iran,_islamic_republic_of', text: 'Iran, Islamic Republic Of' },
    ...
    { value: 'libyan_arab_jamahiriya', text: 'Libyan Arab Jamahiriya' },
    ...
    { value: 'micronesia,_federated_states_of', text: 'Micronesia, Federated States of' },
    { value: 'moldova,_republic_of', text: 'Moldova, Republic of' },
    ...
    { value: 'neutral_zone', text: 'Neutral Zone' },
    { value: 'new_caledonia', text: 'New Caledonia' },
    { value: 'new_zealand', text: 'New Zealand' },
    { value: 'nicaragua', text: 'Nicaragua' },
    { value: 'niger', text: 'Niger' },
    { value: 'nigeria', text: 'Nigeria' },
    { value: 'niue', text: 'Niue' },
    { value: 'norfolk_island', text: 'Norfolk Island' },
    { value: 'northern_mariana_island', text: 'Northern Mariana Island' },
    ...
    { value: 'puerto_rico', text: 'Puerto Rico' },
    ...
    { value: 'saint_helena', text: 'Saint Helena' },
    { value: 'saint_kitts_and_nevis', text: 'Saint Kitts And Nevis' },
    { value: 'saint_lucia', text: 'Saint Lucia' },
    { value: 'saint_pierre_et_miquelon', text: 'Saint Pierre Et Miquelon' },
    { value: 'saint_vincent_and_the_grenadines', text: 'Saint Vincent And The Grenadines' },
    ...
    { value: 'serbia_and_montenegro', text: 'Serbia and Montenegro' },
    { value: 'seychelles', text: 'Seychelles' },
    { value: 'sierra_leone', text: 'Sierra Leone' },
    { value: 'singapore', text: 'Singapore' },
    { value: 'sint_maarten_(dutch_part)', text: 'Sint Maarten (Dutch part)' },
    ...
    { value: 'svalbard_and_jan_mayen', text: 'Svalbard And Jan Mayen' },
    { value: 'swaziland', text: 'Swaziland' },
    { value: 'sweden', text: 'Sweden' },
    { value: 'switzerland', text: 'Switzerland' },
    { value: 'syrian_arab_republic', text: 'Syrian Arab Republic' },
    { value: 'taiwan_province_of_china', text: 'Taiwan Province Of China' },
    { value: 'tajikistan', text: 'Tajikistan' },
    { value: 'tanzania,_united_republic_of', text: 'Tanzania, United Republic of' },
    ...
    { value: 'turks_and_caicos_islands', text: 'Turks And Caicos Islands' },
    { value: 'tuvalu', text: 'Tuvalu' },
    { value: 'uganda', text: 'Uganda' },
    { value: 'ukraine', text: 'Ukraine' },
    { value: 'union_of_soviet_socialist_rep.', text: 'Union Of Soviet Socialist Rep.' },
    ...
    { value: 'united_states_minor_outlying_islands', text: 'United States Minor Outlying Islands' },
    { value: 'uruguay', text: 'Uruguay' },
    { value: 'uzbekistan', text: 'Uzbekistan' },
    { value: 'vanuatu', text: 'Vanuatu' },
    { value: 'venezuela', text: 'Venezuela' },
    { value: 'viet_nam', text: 'Viet Nam' },
    { value: 'virgin_islands,_british', text: 'Virgin Islands, British' },
    { value: 'virgin_islands,_u.s.', text: 'Virgin Islands, U.S.' },
    { value: 'wallis_and_futuna', text: 'Wallis And Futuna' },
    { value: 'western_sahara', text: 'Western Sahara' },
...
$(document).ready(function () {
  ...
  var $select = $('#int_party_type_list');
  $.each(groupedOptions['int_party_type_options'], function(_, option) {
    $select.append($('<option>', { value: option.text, text: option.text }));
  });

  var $select = $('#int_party_country_list');
